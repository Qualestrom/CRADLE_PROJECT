...
class _ListingDetailScreenState extends State<ListingDetailScreen> {
      ...
      body: FutureBuilder<ListingDetails>(
        ...
        builder: (context, snapshot) {
          ...
          if (snapshot.hasData) {
            ...
            final Apartment? apartment = isApartment ? listing as Apartment : null;
            final Bedspace? bedspace = !isApartment ? listing as Bedspace : null;
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    if (imageUrl.isNotEmpty)
                      ClipRRect( // Optional: for rounded corners
                    ...
                    // --- Address ---
                    Text(listing.address, style: Theme.of(context).textTheme.bodyLarge),
                    const SizedBox(height: 16),
                    const Divider(),

                    // --- Price ---
                    _buildDetailRow(context, Icons.attach_money, 'Price:', priceText),
                    const SizedBox(height: 8),

                    // --- Contract ---
                     _buildDetailRow(context, Icons.calendar_today, 'Contract:', contractText),
                    const SizedBox(height: 8),
                    ...
                    // --- Bills Included ---
                    _buildDetailRow(context, Icons.receipt_long, 'Bills Included:', billsIncludedText),
                    const SizedBox(height: 8),

                    // --- Curfew ---
                    _buildDetailRow(context, Icons.nightlight_round, 'Curfew:', curfewText),
                    const SizedBox(height: 16),
                    ...
                    Visibility(
                      ...
                      child: Column(
                        ...
                        children: [
                          const Divider(),
                          const SizedBox(height: 16),
                          Text('Apartment Details', style: Theme.of(context).textTheme.titleMedium),
                          const SizedBox(height: 8),
                          _buildDetailRow(context, Icons.people_alt, 'Capacity:', '${apartment?.capacity ?? 0} person/s'),
                          const SizedBox(height: 8),
                          _buildDetailRow(context, Icons.bed, 'Bedrooms:', '${apartment?.noOfBedrooms ?? 0}'),
                          const SizedBox(height: 8),
                          _buildDetailRow(context, Icons.bathtub, 'Bathrooms:', '${apartment?.noOfBathrooms ?? 0}'),
                          const SizedBox(height: 16),
                        ],
                      ),
                    ),
                    ...
                    Visibility(
                      ...
                      child: Column(
                        ...
                        children: [
                          const Divider(),
                          const SizedBox(height: 16),
                          Text('Bedspace Details', style: Theme.of(context).textTheme.titleMedium),
                          const SizedBox(height: 8),
                           _buildDetailRow(context, Icons.group, 'Roommates:', '${bedspace?.roommateCount ?? 0}'),
                          const SizedBox(height: 8),
                          _buildDetailRow(context, Icons.bathtub_outlined, 'Bathroom Share:', '${bedspace?.bathroomShareCount ?? 0} person/s'),
                           const SizedBox(height: 8),
                           _buildDetailRow(context, Icons.wc, 'Gender:', _formatGenderPreference(bedspace?.gender)),
                          const SizedBox(height: 16),
                        ],
                      ),
                    ),
                    ...
                    const Divider(),
                     ...
                     const SizedBox(height: 8),
                     Text(listing.otherDetails.isNotEmpty ? listing.otherDetails : 'None'),
  ...
  String _formatGenderPreference(GenderPreference? gender) {
    switch (gender) {
      case GenderPreference.maleOnly: return 'Male Only';
      case GenderPreference.femaleOnly: return 'Female Only';
