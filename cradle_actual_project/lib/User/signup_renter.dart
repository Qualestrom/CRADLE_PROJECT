...
class _SignupRenterScreenState extends State<SignupRenterScreen> {
  ...
  void _submitForm() {
    if (_formKey.currentState!.validate()) {
      ...
      print('Name: $name, Age: $age, Sex: $sex, Phone: $phone, Address: $address');
      ...
      children: [
        TextFormField(
          ...
          decoration: InputDecoration(
            ...
            labelStyle: TextStyle(color: labelColor ?? Colors.grey[600]), // Use provided color or default
            floatingLabelBehavior: FloatingLabelBehavior.always,
