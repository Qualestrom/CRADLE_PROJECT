  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      theme: ThemeData(
        ...
        fontFamily: 'Inter', // Added default font
      ),
              ...
              children: <Widget>[
                ...
                Center(
                  child: Container(
                    ...
                    margin: const EdgeInsets.only(bottom: 10), // Add some margin below the handle
                  ),
                ),
                Text(
                  'Continue as:',
                ...
                Padding(
                  padding: EdgeInsets.symmetric(horizontal: buttonHorizontalMargin),
                  child: SizedBox(
