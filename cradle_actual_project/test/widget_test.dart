...
//     // The ForRent object `listing` should now have `imageDownloadUrl` populated
//     // by `processFirestoreListings` (which calls Apartment/Bedspace.fromJson
//     // with data containing the fetched URL).
//     return Card(
